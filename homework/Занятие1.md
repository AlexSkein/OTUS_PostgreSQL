...
1. Начать транзакцию с текущем уровнем изоляции
    ...
    * во второй сессии. видите ли вы новую запись и если да то почему?
    ...
    * завершить первую транзакцию
        ...
        `commit;` 
    * сделать запрос во второй сессии видите ли вы новую запись и если да то почему?
    ...
    * Начать новые транзации в repeatable read
